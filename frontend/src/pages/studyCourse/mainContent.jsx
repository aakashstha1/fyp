    ...
    <>
      <main className="col-span-6 p-6 overflow-y-auto">
        ...
        <div className="p-4 bg-gray-50 rounded border text-sm leading-relaxed text-gray-700">
          <p>
            Companies of all types and sizes rely on user experience designers
            to help make their technology easier and more enjoyable to use. The
            demand for UX designers is so high...
          </p>
        </div>
      </main>
    </>
